...
public final class PlatypusCommand extends Message {
  ...
  private PlatypusCommand(Builder builder) {
    super(builder);
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof PlatypusCommand)) return false;
    PlatypusCommand o = (PlatypusCommand) other;
  ...
  public static final class Builder extends Message.Builder<PlatypusCommand> {
    ...
    public Builder(PlatypusCommand message) {
      super(message);
    ...
    @Override
    public PlatypusCommand build() {
      return new PlatypusCommand(this);
    }
  }
}
